...
public class KaraokeControllerTest {
    ...
    @Test
    public void whenEnqueueRequestThenEnqueues() throws Exception {
        ...
        Optional<SongRequest> enqueuedRequestOpt = karaokeQueueService.dequeue();
        assertThat(enqueuedRequestOpt).isPresent();
        assertThat(enqueuedRequestOpt.get()).isEqualTo(songRequest);
    }

    @Test
    public void whenEnqueueTwoSongRequestsThenGetsInRightOrder() throws Exception {
